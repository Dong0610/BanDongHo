...
namespace BanDongHo.Areas.Admin.Models
{
    public class OrderService
    {
        ...
        {          
            return db.DONHANG.OrderByDescending(n => n.MADH);
        }

        public List<CHITIETDONHANG> LoadOrderDetail(int mahd)
        {
            return db.CHITIETDONHANG.Where(n => n.MADH == mahd).ToList();
        }
        ...
        {
            return db.SANPHAM.Where(n => n.MASP == masp).FirstOrDefault().SOLUONG;
        }
        ...
        {
            return db.SANPHAM.Where(n => n.MASP == masp).FirstOrDefault();
        }
